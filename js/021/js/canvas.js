...
(function($) {
	...
	this.cvpos.y = $cvdiv.offset().top;
        ...
        this.radius = 16; // raduis of balls
	...
	this.blank = function() {
        ...
        this.moveObj = function() {
            ...
            for (var i = 0; i < this.ball.length; i++) {
                ...
                this.ball[i].v.x += intervalAccel.x;
                this.ball[i].v.y += intervalAccel.y;
            }
            ...
            for (var i = 0; i < this.ball.length; i++) {
                ...
                var r = this.radius;
                if (p.x - r < 1) {
                    p.x = r + 1; v.x = -v.x*this.cor;
                } else if (p.x + r > this.area.w) {
                    p.x = this.area.w - r - 1; v.x = -v.x*this.cor;
                }
                if (p.y - r < 0) {
                    p.y = r + 1; v.y = -v.y*this.cor;
                } else if (p.y + r > this.area.h) {
                    p.y = this.area.h - r - 1; v.y = -v.y*this.cor;
                }
            }

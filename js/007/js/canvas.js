...
(function($) {
	 ...
	 */
        ...
        this.setSpeedMovedObj_old = function() {
            if (this.releasedBallIdx != null) {
                ...
                this.ball[this.releasedBallIdx].speed.abs = 
                    Math.sqrt(this.ball[this.releasedBallIdx].speed.x*
                              this.ball[this.releasedBallIdx].speed.x +
                              this.ball[this.releasedBallIdx].speed.y*
                              this.ball[this.releasedBallIdx].speed.y);
        ...
        this.setSpeedMovedObj = function() {
            ...
            if (this.holdBallIdx != null) {
                ...
                if (reducedAbsSpeed >= curSpeed.abs) {
                    this.ball[this.holdBallIdx].speed.x =
                        reducedAbsSpeed*this.ball[this.holdBallIdx].speed.x/
                        this.ball[this.holdBallIdx].speed.abs;
                    this.ball[this.holdBallIdx].speed.y =
                        reducedAbsSpeed*this.ball[this.holdBallIdx].speed.y/
                        this.ball[this.holdBallIdx].speed.abs;
                    this.ball[this.holdBallIdx].speed.abs = reducedAbsSpeed;
                } else {
